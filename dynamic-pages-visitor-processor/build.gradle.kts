...
mavenPublishing {
    ...
    coordinates("io.github.javierpe", "visitor-processor", libs.versions.dynamicPages.get())

    pom {
        name = "Dynamic Pages Visitor Processor"
        description = "Dynamic Visitor Processor"
        inceptionYear = "2025"
